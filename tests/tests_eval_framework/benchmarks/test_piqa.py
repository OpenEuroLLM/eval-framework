...
from eval_framework.benchmarks.piqa import _IDK_PREAMBLE, PIQA_BENCHMARKS, piqa, piqa_idk, piqa_olmes
...
@pytest.mark.parametrize("benchmark", PIQA_BENCHMARKS, ids=lambda b: b.id())
